...
<form class="contact-form" action="#" method="POST">
  ...
  <div class="form-group">
    ...
    <textarea id="project" name="project" placeholder="What are you planning? Bathroom, kitchen, apartment? Any details you'd like to share."></textarea>
  </div>
...
<form class="contact-form" action="#" method="POST">
  ...
  <div class="form-group">
    ...
    <textarea id="question" name="question" placeholder="What would you like to know?"></textarea>
  </div>
