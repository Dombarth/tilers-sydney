...
description: "A people-first guide to waterproofing before tiling in Ryde NSW: what happens first, what a tiler coordinates, cure time, documentation, and the common failure modes to avoid."
permalink: /waterproofing-before-tiling-ryde/
faq:
  - q: "Do tiles and grout make a bathroom waterproof?"
    a: "No. Tiles and grout are not a waterproof system on their own. Waterproofing is the layer that protects the structure from moisture, and it needs correct preparation, detailing, and cure time before tiling starts."
...
1) **Substrate prep** (flat, stable, suitable)
2) **Licensed waterproofing** (NSW wet areas)
3) **Cure time** (do not compress)
4) **Tiling** (setout, cuts, levelling)
5) **Grout + silicone** (silicone in corners/junctions)
...
5) **Will documentation be provided?** (where applicable)
6) **How will corners/junctions be finished?** (silicone vs grout)
...
If strata logistics apply, read: <a href="/apartment-tiling-ryde-strata/">Apartment tiling in Ryde (strata logistics)</a>.
